...
function diffDayTime(a, b) {
	return moment.duration({
		days: a.clone().stripTime().diff(b.clone().stripTime(), 'dias'),
...
function divideRangeByDuration(start, end, dur) {
	...
	if (Math.abs(months) >= 1 && isInt(months)) {
		return end.diff(start, 'mes', true) / months;
	}
	return end.diff(start, 'dias', true) / dur.asDays();
}
...
var tokenGranularities = {
	Y: { value: 1, unit: 'año' },
	M: { value: 2, unit: 'mes' },
	W: { value: 3, unit: 'semana' },
	w: { value: 3, unit: 'semana' },
	D: { value: 4, unit: 'dia' }, // day of month
	d: { value: 4, unit: 'dia' } // day of week
};
